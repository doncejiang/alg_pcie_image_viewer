...
//read only
#define VDMA0_FRM_PTR_OFFSET (0 * 4)
#define VDMA1_FRM_PTR_OFFSET (1 * 4)
#define VDMA2_FRM_PTR_OFFSET (2 * 4)
#define VDMA3_FRM_PTR_OFFSET (3 * 4)
#define VDMA4_FRM_PTR_OFFSET (4 * 4)
#define VDMA5_FRM_PTR_OFFSET (5 * 4)
#define VDMA6_FRM_PTR_OFFSET (6 * 4)
#define VDMA7_FRM_PTR_OFFSET (7 * 4)
//read write
#define HOST2SOC_INFO1_OFFSET (8 * 4)
#define HOST2SOC_INFO2_OFFSET (9 * 4)
#define HOST2SOC_INFO3_OFFSET (10 * 4)
//read write
#define RAISE_SLV_IRQ_OFFSET (11 * 4)
//read only
#define SOC2HOST_INFO1_OFFSET (16 * 4)
#define SOC2HOST_INFO2_OFFSET (17 * 4)
#define SOC2HOST_INFO3_OFFSET (18 * 4)
#define SOC2HOST_INTR_CTL_OFFSET (19 * 4)
//read only
